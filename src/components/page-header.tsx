...
export default function PageHeader({ children, className }: PageHeaderProps) {
  ...
  return (
    <header className={cn("sticky bg-background top-0 z-50 flex h-16 shrink-0 items-center gap-2 border-b transition-[width,height] ease-linear group-has-data-[collapsible=icon]/sidebar-wrapper:h-12", {className})}>
