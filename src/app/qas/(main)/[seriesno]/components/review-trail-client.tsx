...
export default function ReviewTrailClient({ initialTrails, jobTransaction, currentUserId }: ReviewTrailProps) {
    ...
    <>
      {hasAnyPermission ? (
        <TrailContainer
          ...
          canWrite={permissions.isAuditor || permissions.isOfficer || permissions.isSupervisor}
