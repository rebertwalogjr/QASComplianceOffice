...
export const columns: ColumnDef<TypeOfFinding>[] = [
  ...
  {
    accessorKey: "requireAcceptance",
    header: "Require Acceptance",
    cell: ({ row }) => {
      return <Badge variant="outline"
        className={row.original.requireAcceptance === true ? "bg-green-50 text-green-500 border-green-500" : "bg-gray-50 text-gray-600 border-gray-600"}
      >
        {row.original.requireAcceptance === true ? "Yes" : "No"}
      </Badge>
    }
  },
  {
