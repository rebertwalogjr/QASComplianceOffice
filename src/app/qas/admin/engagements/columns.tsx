...
export const columns: ColumnDef<AuditEngagement>[] = [
  ...
  },
  {
    ...
    cell: ({ row }) => {
      return <Badge variant="outline" className={ row.original.isActive ? "bg-green-50 text-green-500 border-green-500" : "bg-gray-50 text-gray-600 border-gray-600" } >{ row.original.isActive ? "Active" : "Inactive" }</Badge>
    }
  },
]